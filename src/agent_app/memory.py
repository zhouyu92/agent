...
class MemoryStore:
    def __init__(self, db_path: str | Path) -> None:
        ...
        self.semantic_store = SqliteSemanticMemoryStore(self.db_path)
    ...
    def recent_memory_evolution_events(
        ...
        *,
        ...
        return self.audit_store.recent_memory_evolution_events(user_id=user_id, limit=limit, thread_id=thread_id)
